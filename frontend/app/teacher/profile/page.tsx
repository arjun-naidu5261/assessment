    ...
    <div className="mx-auto max-w-2xl">
      <div className="mb-10">
        ...
        <p className="mt-2 max-w-lg text-[var(--text-secondary)]">
          Update how you appear to students and keep your password secure.
        </p>
      </div>
      ...
      <section className="mb-10 rounded-[var(--radius)] border border-[var(--border)] bg-[var(--surface)] p-6 shadow-[var(--shadow)] sm:p-8">
        <h2 className="font-display text-lg font-semibold text-[var(--text)]">Public name</h2>
        <p className="mt-1 text-sm text-[var(--text-secondary)]">
          Shown in class lists and on graded work.
        </p>
        <form onSubmit={saveIdentity} className="mt-6 space-y-5">
          ...
          <label className="block">
            ...
            <span className="mt-1 block text-xs text-[var(--muted)]">
              Email sign-in cannot be changed here yet.
            </span>
          </label>
          <button
            type="submit"
      ...
      <section className="rounded-[var(--radius)] border border-[var(--border)] bg-[var(--surface)] p-6 shadow-[var(--shadow)] sm:p-8">
        ...
        <p className="mt-1 text-sm text-[var(--text-secondary)]">
          Leave blank if you only want to update your name above.
        </p>
        <form onSubmit={savePassword} className="mt-6 space-y-5">
          ...
          <button
            ...
            className="rounded-[12px] border border-[var(--border-strong)] bg-transparent px-5 py-2.5 text-sm font-semibold text-[var(--text)] transition hover:bg-white/[0.04] disabled:opacity-40"
          >
            Update password
          </button>
        </form>
